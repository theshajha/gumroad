...
categories = [
  { name: 'Software Development', slug: 'software-development', description: 'Learn to code and tools to help you code more productively.', icon: "https://assets.gumroad.com/packs/static/8915495939281be47257.svg", total_sales: 23000000, total_creators: 21000, total_products: 1020000, background_color: '#DC341E', text_color: '#000000' },
  { name: '3D', slug: '3d', description: 'Perfect your craft with the same tools used at Dreamworks and Pixar.', icon: "https://assets.gumroad.com/packs/static/8915495939281be47257.svg", total_sales: 18000000, total_creators: 14000, total_products: 790000, background_color: '#23A094', text_color: '#000000'},
  ...
  { name: 'Music & Sound Design', slug: 'music-sound-design', description: 'Tracks, beats, and loops from the best musicians and engineers in the biz.', total_sales: 26000000, total_creators: 21000, total_products: 870000, background_color: '#F1F333', text_color: '#000000'},
  ...
  { name: 'Comics & Graphic Novels', slug: 'comic-graphics', description: 'Sequential art with loads of heart. Welcome to a paradise of panels.', total_sales: 26000000, total_creators: 21000, total_products: 870000, background_color: '#F1F333', text_color: '#000000'},
  ...
  { name: 'Audio', slug: 'audio', description: 'Open your ears and mind to interviews, meditations, and true crime thrillers.', total_sales: 26000000, total_creators: 21000, total_products: 870000, background_color: '#DC341E', text_color: '#000000'},
  { name: 'Recorded Music', slug: 'recorded-music', description: 'Tracks and albums from the best musicians and artists in the biz.', total_sales: 26000000, total_creators: 21000, total_products: 870000, background_color: '#23A094', text_color: '#000000'},
  { name: 'Films', slug: 'films', description: 'Have a movie night with some of the best stories to hit the small screen.', total_sales: 26000000, total_creators: 21000, total_products: 870000, background_color: '#23A094', text_color: '#000000'},
