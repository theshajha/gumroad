...
const ListingCard = (props: { listing: ListingsType }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center p-px border border-[#646464]">
            <div
                className={clsx(
                    'lightgray 50% / cover no-repeat] w-60 h-60 bg-cover bg-center  '
                )}
            ...
            <div className="flex flex-col justify-center items-center gap-6 self-stretch py-4 px-2 border-t border-t-[#4d4d4d]">
                <div className="self-stretch text-white text-xs text-left font-[mabry pro] leading-[normal]">
